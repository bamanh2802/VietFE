       ...
       <div className="fixed right-0 bottom-0 h-[calc(100vh-64px)]">
        ...
        <div
          className={`transition-all duration-300 ease-in-out ${
            isMessage ? 'w-64' : 'w-0'
          } bg-gray-100 h-full overflow-x-hidden overflow-y-auto`}
        >
            ...
            <div className="space-y-2 w-full">
              {conversation.messages
                ...
                .map((msg) => (
                  <div
                    key={msg.id}
                    className="p-1 text-xs cursor-pointer transition-all bg-gray-300 rounded-xl shadow hover:bg-gray-400 w-full text-ellipsis truncate"
